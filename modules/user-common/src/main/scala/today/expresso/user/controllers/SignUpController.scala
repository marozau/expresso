...
class SignUpController @Inject()(
  ...
  /**
    ...
    */
  def view = silhouette.SecuredAction(WithRole(User.Role.ADMIN, User.Role.EDITOR)).async { implicit request: Request[AnyContent] =>
  ...
  /**
    ...
    * @return The result to display.
    */
  def submit = silhouette.SecuredAction(WithRole(User.Role.ADMIN, User.Role.EDITOR)).async { implicit request: Request[AnyContent] =>
