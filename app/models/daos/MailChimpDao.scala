...
import clients.MailChimpApi.{Activity, Campaign, Member}
...
/**
  ...
  */
@Singleton
class MailChimpDao @Inject()(protected val dbConfigProvider: DatabaseConfigProvider)(implicit ec: ExecutionContext)
  extends Repository {
